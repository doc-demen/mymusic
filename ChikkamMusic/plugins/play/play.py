#
# Copyright (C) 2021-2022 byMoni_Help@Github, < https://github.com/TheTeamMoni >.
...
from ChikkamMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from ChikkamMusic.core.call import Moni
from ChikkamMusic.utils import seconds_to_min, time_to_seconds
from ChikkamMusic.utils.channelplay import get_channeplayCB
from ChikkamMusic.utils.database import is_video_allowed
from ChikkamMusic.utils.decorators.language import languageCB
from ChikkamMusic.utils.decorators.play import PlayWrapper
from ChikkamMusic.utils.formatters import formats
from ChikkamMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from ChikkamMusic.utils.inline.playlist import botplaylist_markup
from ChikkamMusic.utils.logger import play_logs
from ChikkamMusic.utils.stream.stream import stream
...
@app.on_callback_query(filters.regex("MoniPlaylists") & ~BANNED_USERS)
@languageCB
