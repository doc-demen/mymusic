...
from ChikkamMusic import Telegram, YouTube, app
from ChikkamMusic.misc import SUDOERS
from ChikkamMusic.plugins.play.playlist import del_plist_msg
from ChikkamMusic.plugins.sudo.sudoers import sudoers_list
...
from ChikkamMusic.utils.decorators.language import LanguageStart
from ChikkamMusic.utils.inline import help_pannel, private_panel, start_pannel
from ChikkamMusic.utils.command import commandpro
...
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("𓆩𓆩𝄞𓆪𓆪 ᴄʜᴀᴛ 𓆩𓆩𝄞𓆪𓆪", url=f"{SUPPORT_CHAT}")]]
        ),
    )
