...
from ChikkamMusic import YouTube, app
from ChikkamMusic.core.userbot import assistants
from ChikkamMusic.misc import SUDOERS, pymongodb
from ChikkamMusic.plugins import ALL_MODULES
from ChikkamMusic.utils.database import (
    get_global_tops,
    get_particulars,
    get_queries,
    get_served_chats,
...
from ChikkamMusic.utils.decorators.language import language, languageCB
from ChikkamMusic.utils.inline.stats import (
    back_stats_buttons,
    back_stats_markup,
    get_stats_markup,
    ...
    def get_stats():
        ...
        if what in ["Tracks", "Here"]:
            for items, count in list_arranged.items():
                ...
                if items == "telegram":
                    msg += f"𓆩♡𓆪 [ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/Shayri_Music_Lovers) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                else:
                    msg += f"𓆩♡𓆪 [{title}](https://www.youtube.com/watch?v={items}) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
...
async def overall_stats(client, CallbackQuery, _):
    ...
    text = f"""𓆩♡𓆪 **ʙᴏᴛ's sᴛᴀᴛs ᴀɴᴅ ɪɴғᴏ:**

𓆩♡𓆪 **ᴍᴏᴅᴜʟᴇs:** {mod}
𓆩♡𓆪 **ᴄʜᴀᴛs:** {served_chats} 
𓆩♡𓆪 **ᴜsᴇʀs:** {served_users} 
𓆩♡𓆪 **ʙʟᴏᴄᴋᴇᴅ:** {blocked} 
𓆩♡𓆪 **sᴜᴅᴏᴇʀs:** {sudoers} 
    
𓆩♡𓆪 **ǫᴜᴇʀɪᴇs:** {total_queries} 
𓆩♡𓆪 **ᴀssɪsᴛᴀɴᴛs:** {assistant}
𓆩♡𓆪 **ᴀss ᴀᴜᴛᴏ ʟᴇᴀᴠᴇ:** {ass}
𓆩♡𓆪 **ᴄʟᴇᴀɴᴍᴏᴅᴇ:** {cm} ᴍɪɴᴜᴛᴇs

𓆩♡𓆪 **ᴅᴜʀᴀᴛɪᴏɴ ʟɪᴍɪᴛ:** {play_duration} ᴍɪɴᴜᴛᴇs
𓆩♡𓆪 **ᴅᴏᴡɴʟᴏᴀᴅ ʟɪᴍɪᴛ:** {song} ᴍɪɴᴜᴛᴇs
𓆩♡𓆪 **ᴩʟᴀʏʟɪsᴛ ʟɪᴍɪᴛ:** {playlist_limit}
𓆩♡𓆪 **ᴩʟᴀʏʟɪsᴛ ᴩʟᴀʏ ʟɪᴍɪᴛ:** {fetch_playlist}"""
...
async def overall_stats(client, CallbackQuery, _):
    ...
    text = f"""𓆩♡𓆪 **ʙᴏᴛ's sᴛᴀᴛs ᴀɴᴅ ɪɴғᴏ:**
       ...
       <b><u>𓆩♡𓆪 ʜᴀʀᴅᴡᴀʀᴇ</b><u/>
𓆩♡𓆪 **ᴍᴏᴅᴜʟᴇs:** {mod}
𓆩♡𓆪 **ᴩʟᴀᴛғᴏʀᴍ:** {sc}
𓆩♡𓆪 **ʀᴀᴍ:** {ram}
𓆩♡𓆪 **ᴩʜʏsɪᴄᴀʟ ᴄᴏʀᴇs:** {p_core}
𓆩♡𓆪 **ᴛᴏᴛᴀʟ ᴄᴏʀᴇs:** {t_core}
𓆩♡𓆪 **ᴄᴩᴜ ғʀᴇǫᴜᴇɴᴄʏ:** {cpu_freq}

       <b><u>𓆩♡𓆪 sᴏғᴛᴡᴀʀᴇ</b><u/>
𓆩♡𓆪 **ᴩʏᴛʜᴏɴ :** {pyver.split()[0]}
𓆩♡𓆪 **ᴩʏʀᴏɢʀᴀᴍ :** {pyrover}
𓆩♡𓆪 **ᴩʏ-ᴛɢᴄᴀʟʟs :** {pytgver}

        <b><u>𓆩♡𓆪 sᴛᴏʀᴀɢᴇ</b><u/>
𓆩♡𓆪 **ᴀᴠᴀɪʟᴀʙʟᴇ:** {total[:4]} GiB
𓆩♡𓆪 **ᴜsᴇᴅ:** {used[:4]} GiB
𓆩♡𓆪 **ғʀᴇᴇ:** {free[:4]} GiB

      <b><u>𓆩♡𓆪 ᴄᴜʀʀᴇɴᴛ sᴛᴀᴛs</b><u/>
𓆩♡𓆪 **ᴄʜᴀᴛs:** {served_chats} 
𓆩♡𓆪 **ᴜsᴇʀs:** {served_users} 
𓆩♡𓆪 **ʙʟᴏᴄᴋᴇᴅ:** {blocked} 
𓆩♡𓆪 **sᴜᴅᴏᴇʀs:** {sudoers} 

      <b><u>𓆩♡𓆪 ᴍᴏɴɢᴏ ᴅᴀᴛᴀʙᴀsᴇ</b><u/>
𓆩♡𓆪 **ᴜᴩᴛɪᴍᴇ:** {mongouptime[:4]} ᴅᴀʏs
𓆩♡𓆪 **sɪᴢᴇ:** {datasize[:6]} ᴍʙ
𓆩♡𓆪 **sᴛᴏʀᴀɢᴇ:** {storage} ᴍʙ
𓆩♡𓆪 **ᴄᴏʟʟᴇᴄᴛɪᴏɴs:** {collections}
𓆩♡𓆪 **ᴋᴇʏs:** {objects}
𓆩♡𓆪 **ǫᴜᴇʀɪᴇs:** `{query}`
𓆩♡𓆪 **ʙᴏᴛ ǫᴜᴇʀɪᴇs:** `{total_queries}`
    """
    med = InputMediaPhoto(media=config.STATS_IMG_URL, caption=text)
    try:
        await CallbackQuery.edit_message_media(media=med, reply_markup=upl)
