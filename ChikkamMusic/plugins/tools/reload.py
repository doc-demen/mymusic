...
from ChikkamMusic.utils.database import get_authuser_names, get_cmode
from ChikkamMusic.utils.decorators import ActualAdminCB, AdminActual, language
from ChikkamMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Moni.stop_stream(message.chat.id)
    except:
        pass
